...
struct StoryBrain {
    ...
    mutating func nextStory(userChoice: Int) {
        if userChoice == 1 {
         self.currentStoryNumber = self.stories[self.currentStoryNumber].choice1Destination
        } else if userChoice == 2 {
            self.currentStoryNumber = self.stories[self.currentStoryNumber].choice2Destination
        }
    }
}
